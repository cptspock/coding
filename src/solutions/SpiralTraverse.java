...
public class SpiralTraverse {
	public List<Integer> spiralTraverse(int[][] array) {
		...
		int startRow = 0, endRow = array.length - 1,
			startCol = 0, endCol = array[0].length - 1; // important since # of rows may not be = # of cols
	...
	public static void main(String[] args) {
		...
		// check
		int[][] array = { { 1, 2, 3 }, { 12, 13, 4 },
			{ 11, 14, 5 }, { 10, 15, 6 }, { 9, 8, 7 } }; // startCol == endCol
															// check
		List<Integer> result = new SpiralTraverse()
			.spiralTraverse(null);
